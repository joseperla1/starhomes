...
(function () {
  ...
  function renderListings(listings) {
    listings.forEach(listing => {
      ...
      const line  = `🏠 ${listing.type || 'Property'} · ${listing.area || 'Chicago'} · ${price}`;
      addMessage(line, 'bot');
    });
  }
